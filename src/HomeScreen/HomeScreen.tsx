...
import { View, Text, Image, TouchableOpacity, ImageBackground, SafeAreaView, ScrollView, FlatList } from 'react-native'
      ...
      <ScrollView>
        ...
        <View style={[styles.newarrival]}>
          ...
          <View style={[styles.category]}>
            <View style={[styles.maincategory]}>
              <TouchableOpacity onPress={() => setScreen('All')} style={[styles.btnAll]}>
                <Text
                  style={[
                    styles.scname,
                    {
                ...
                <View style={{ width: 4, height: 4, backgroundColor: screen == 'All' ? '#DD8560' : '#fff', transform: [{ rotate: '45deg' }], marginTop: verticalScale(4) }}></View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setScreen('Apparel')} style={[styles.btnApparel]}>
                <Text
                  style={[
                    styles.scname,
                    {
                ...
                <View style={{ width: 4, height: 4, backgroundColor: screen == 'Apparel' ? '#DD8560' : '#fff', transform: [{ rotate: '45deg' }], marginTop: verticalScale(4) }}></View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setScreen('Dress')} style={[styles.btnDress]}>
                <Text
                  style={[
                    styles.scname,
                    {
                ...
                <View style={{ width: 4, height: 4, backgroundColor: screen == 'Dress' ? '#DD8560' : '#fff', transform: [{ rotate: '45deg' }], marginTop: verticalScale(4) }}></View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setScreen('Tshirt')} style={[styles.btnTshirt]}>
                <Text
                  style={[
                    styles.scname,
                    {
                ...
                <View style={{ width: 4, height: 4, backgroundColor: screen == 'Tshirt' ? '#DD8560' : '#fff', transform: [{ rotate: '45deg' }], marginTop: verticalScale(4) }}></View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setScreen('Bag')} style={[styles.btnBag]}>
                <Text
                  style={[
                    styles.scname,
                    {
                ...
                <View style={{ width: 4, height: 4, backgroundColor: screen == 'Bag' ? '#DD8560' : '#fff', transform: [{ rotate: '45deg' }], marginTop: verticalScale(4) }}></View>
              </TouchableOpacity>
            </View>
          </View>
          <ToggleScreen />
        ...
        <View style={[styles.collections]}>
          ...
          <ImageBackground
            ...
            source={
              require('../../assets/image/image12.png')
            }
          >
          ...
          <ImageBackground
            ...
            source={
              require('../../assets/image/image9.png')
            }>
        ...
        <View style={[styles.video]}>
          <ImageBackground
            ...
            source={
              require('../../assets/image/imagevideo.png')
            }>
              ...
              return (
                <View style={styles.groupProduct}>
                  <TouchableOpacity style={styles.product} onPress={() => navigation.navigate('Detail')} >
                    <Image source={{ uri: item.imgUrl }} style={styles.productImage} resizeMode="cover" />
